...
BeanBoardSPI is a design for a SPI interface specifically to extend [BeanZee](https://github.com/PainfulDiodes/BeanZee) / [BeanBoard](https://github.com/PainfulDiodes/BeanBoard) - a homebrew Z80 computer.
